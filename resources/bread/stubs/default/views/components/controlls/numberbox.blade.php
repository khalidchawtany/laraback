                ...
                <input id="bread_model_variable_bread_attribute_name" name="bread_attribute_name" value="<?= $bread_model_variable->bread_attribute_name ?>"
                        class="easyui-numberbox w-500" data-options="required: true, label:'', labelPosition:'left', precision:'<?= __('NumberboxPrecission') ?>', groupSeparator:',',suffix:'<?= __('CurrencySuffix') ?>', prefix:'<?= __('CurrencyPrefix') ?>',">
